		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getTransactionAccess().getAlternatives_17_2(), "rule__Transaction__Alternatives_17_2");
					...
					put(grammarAccess.getSearchLocationAccess().getAlternatives(), "rule__SearchLocation__Alternatives");
					...
					put(grammarAccess.getTransactionAccess().getGroup_17(), "rule__Transaction__Group_17__0");
					put(grammarAccess.getResponseHandlerAccess().getGroup(), "rule__ResponseHandler__Group__0");
					...
					put(grammarAccess.getTransactionAccess().getResponsehandlerAssignment_15(), "rule__Transaction__ResponsehandlerAssignment_15");
					put(grammarAccess.getTransactionAccess().getCapturefilenameAssignment_16_1(), "rule__Transaction__CapturefilenameAssignment_16_1");
					put(grammarAccess.getTransactionAccess().getTextAssignment_17_1(), "rule__Transaction__TextAssignment_17_1");
					put(grammarAccess.getResponseHandlerAccess().getNameAssignment_3(), "rule__ResponseHandler__NameAssignment_3");
					put(grammarAccess.getResponseHandlerAccess().getResponsehandlernameAssignment_5(), "rule__ResponseHandler__ResponsehandlernameAssignment_5");
					put(grammarAccess.getResponseHandlerAccess().getProtocolAssignment_7(), "rule__ResponseHandler__ProtocolAssignment_7");
					put(grammarAccess.getResponseHandlerAccess().getQuerytypeAssignment_9(), "rule__ResponseHandler__QuerytypeAssignment_9");
					put(grammarAccess.getResponseHandlerAccess().getQuerystringAssignment_11(), "rule__ResponseHandler__QuerystringAssignment_11");
					put(grammarAccess.getResponseHandlerAccess().getOrdinalAssignment_13(), "rule__ResponseHandler__OrdinalAssignment_13");
					put(grammarAccess.getResponseHandlerAccess().getSearchlocationAssignment_15(), "rule__ResponseHandler__SearchlocationAssignment_15");
