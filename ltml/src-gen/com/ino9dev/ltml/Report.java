...
public interface Report extends EObject
{
   ...
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Hps</em>' attribute isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * @return the value of the '<em>Hps</em>' attribute.
   * @see #setHps(boolean)
   * @see com.ino9dev.ltml.LtmlPackage#getReport_Hps()
   * @model
   * @generated
   */
  boolean isHps();
  ...
  /**
   * Sets the value of the '{@link com.ino9dev.ltml.Report#isHps <em>Hps</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @param value the new value of the '<em>Hps</em>' attribute.
   * @see #isHps()
   * @generated
   */
  void setHps(boolean value);
